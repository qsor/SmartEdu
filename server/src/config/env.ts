...
let accessTokenLifetime = Duration.from(accessTokenLifetimeRaw)
...
let refreshTokenLifetime = Duration.from(refreshTokenLifetimeRaw)
...
let refreshTokenCookieLifetime = Duration.from(refreshTokenCookieLifetimeRaw)
