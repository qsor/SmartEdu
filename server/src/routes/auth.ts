...
export function authRoutes(
    ...
    router.post('/auth/register', async (req, res: Response<RegisterResponse>) => {
        ...
        const { firstName, lastName } = getRegisterFirstLastNames(body)
...
function getRegisterFirstLastNames(body: RegisterRequestBody): { firstName: string, lastName: string | null } {
